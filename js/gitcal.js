            ...
            var responsiveChart = () => {
                if(document.getElementById("gitcanvas")){
                    ...
                    if (document.body.clientWidth > 700) {
                        ...
                        github_calendar_ctx.fillText("Mon", 0, 1.9 * linemaxwitdh);
                        github_calendar_ctx.fillText("Tue", 0, 3.9 * linemaxwitdh);
                        github_calendar_ctx.fillText("Thr", 0, 5.9 * linemaxwitdh);
